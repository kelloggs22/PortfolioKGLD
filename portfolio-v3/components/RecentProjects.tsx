...
import { transform } from 'framer-motion/debug';
        ...
        {projects.map(({
            ...
            <div key={id} className=' sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[90vw]'>
                <PinContainer title={link} href={link} >
                    <div className='relative flex items-center justify-center sm:w-[570px] sm:h-[40vh] w-[80vw] oveflow-hidden h-[30vh] mb-10'>
                    ...
                    <p className='lg:text-xl lg:font-normal font-lighttext-sm line-clamp-2'>
                        {des}
                    </p>
